...
<div class="row">
    <div class="col-sm mt-3 mt-md-0">
        {% include figure.liquid loading="eager" path="assets/img/eda_01.webp" title="EDA Upload Data" class="img-fluid" %}
    </div>
</div>
...
<div class="row">
    <div class="col-sm mt-3 mt-md-0">
        {% include figure.liquid loading="eager" path="assets/img/eda_02.webp" title="EDA Summary Statistics" class="img-fluid" %}
    </div>
</div>
...
<div class="row">
    <div class="col-sm mt-3 mt-md-0">
        {% include figure.liquid loading="eager" path="assets/img/eda_03.webp" title="EDA Correlation Matrix Heatmap" class="img-fluid" %}
    </div>
</div> 
...
<div class="row">
    <div class="col-sm mt-3 mt-md-0">
        {% include figure.liquid loading="eager" path="assets/img/eda_04.webp" title="EDA Histogram" class="img-fluid" %}
    </div>
</div> 
...
<div class="row">
    <div class="col-sm mt-3 mt-md-0">
        {% include figure.liquid loading="eager" path="assets/img/eda_05.webp" title="EDA Bar Chart" class="img-fluid" %}
    </div>
</div>  
...
<div class="row">
    <div class="col-sm mt-3 mt-md-0">
        {% include figure.liquid loading="eager" path="assets/img/eda_06.webp" title="EDA Scatter Plot" class="img-fluid" %}
    </div>
</div>   
...
Head over to the [EDA Dashboard](https://github.com/rj-price/eda_dashboard) and give it a try. I’d love to hear your feedback!  
